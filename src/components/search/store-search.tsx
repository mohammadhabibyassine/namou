        ...
        <div className="namou-container py-5 sm:py-8">
          ...
          >
            ...
            <button
              type="submit"
              disabled={!query.trim()}
              className="bg-acid absolute top-1/2 right-0 flex min-h-11 -translate-y-1/2 items-center gap-3 rounded-lg px-4 font-mono text-[10px] uppercase disabled:opacity-35"
            >
          ...
          {debouncedQuery.length < 2 ? (
              ...
              <div className="flex flex-wrap gap-2">
                {suggestions.map((suggestion) => (
                  <button
                    ...
                    className="border-line bg-surface hover:bg-acid rounded-full border px-4 py-2 font-mono text-[10px] uppercase transition-colors hover:border-black"
                  >
                    {suggestion}
                  </button>
                ))}
            ...
            <div className="grid min-h-48 place-items-center" role="status">
              <div className="text-center">
                <LoaderCircle className="mx-auto animate-spin" size={22} />
            ...
            <div className="py-6">
              ...
              <button
                ...
                className="border-line hover:bg-acid mt-4 flex min-h-11 w-full items-center justify-center gap-4 border font-mono text-[10px] uppercase"
              >
