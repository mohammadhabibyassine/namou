          ...
          {!authenticated ? (
            <div className="grid flex-1 place-items-center p-6 text-center">
              <div>
                ...
                <Link
                  ...
                  onClick={() => setOpen(false)}
                  className="action-button mt-5 inline-block rounded-lg px-5 py-3 font-mono text-[9px] uppercase"
                >
                  Login to chat
                </Link>
              </div>
            ...
            >
              <div className="w-full text-center">
                ...
                <button className="action-button mt-3 min-h-11 w-full rounded-lg font-mono text-[9px] uppercase">
                  Start conversation
                </button>
              </div>
            </form>
