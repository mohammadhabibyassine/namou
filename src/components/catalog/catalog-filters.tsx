          ...
          {active.length ? (
            active.map((filter) => (
              <Link
                ...
                href={filter.href}
                className="bg-acid text-ink inline-flex shrink-0 items-center gap-2 px-3 py-2 font-mono text-[9px] font-semibold uppercase transition-[filter,transform] hover:brightness-95 active:scale-95"
              >
      ...
      >
        <form action="/shop" className="sticky top-24 space-y-7 py-2">
          <FilterFields
            ...
            filters={filters}
          />
          <button className="bg-ink hover:bg-acid h-11 w-full font-mono text-[10px] text-white uppercase transition-colors hover:text-black">
            Apply filters
          </button>
          <Link
            href="/shop"
      ...
      <details className="border-line bg-surface col-span-full border lg:hidden">
        ...
        <form action="/shop" className="space-y-6 border-t border-black/10 p-4">
          <FilterFields
            ...
            filters={filters}
          />
          <button className="bg-acid h-12 w-full font-mono text-[10px] font-semibold uppercase">
            Apply filters
          </button>
          <Link
            href="/shop"
