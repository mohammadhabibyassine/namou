...
import { CommerceFeedback } from "@/components/commerce/commerce-feedback";
        ...
        <div className="namou-container flex h-16 items-center justify-between gap-5 sm:h-[76px]">
          ...
          >
            {links.map((link) => (
              <Link
                ...
                className="relative py-2 tracking-wide transition-opacity after:absolute after:right-0 after:bottom-0 after:left-0 after:h-px after:origin-left after:scale-x-0 after:bg-current after:transition-transform hover:opacity-60 hover:after:scale-x-100 aria-[current=page]:after:scale-x-100"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            <button
              ...
              className="inline-flex min-h-11 items-center gap-2 px-2 text-xs uppercase transition-opacity hover:opacity-55 sm:px-3"
              aria-haspopup="dialog"
              aria-expanded={searchOpen}
              aria-controls="namou-search-system"
            >
            ...
            <Link
              href="/cart"
              className="hover:bg-muted relative grid size-11 place-items-center rounded-full transition-colors"
