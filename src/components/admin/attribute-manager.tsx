  ...
  return (
    <section className="hairline-panel p-5">
      ...
      >
        ...
        >
          {save.isPending ? "Saving…" : attribute ? "Save type" : "Create type"}
        </button>
      </form>
      {attribute ? (
        <div className="border-line mt-7 border-t pt-6">
          ...
          >
            ...
            <button
              className="bg-acid grid size-11 place-items-center rounded-lg"
            ...
            query.data?.map((attribute) => (
              <button
                ...
                className={cn(
                  ...
                  selectedId === attribute.id ? "bg-acid" : "hover:bg-muted",
                )}
              >
                <span>
