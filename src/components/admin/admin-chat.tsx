          ...
          <section className="flex min-h-[36rem] flex-col">
              ...
              <div className="flex items-center gap-2">
                {!active.assignedAdminId ? (
                  <button
                    ...
                    className="bg-acid inline-flex min-h-9 items-center gap-2 rounded-lg px-3 font-mono text-[9px] font-bold tracking-wider text-black uppercase transition-opacity hover:opacity-90 disabled:opacity-50"
                  >
                    {assign.isPending ? (
            ...
            {!active.assignedAdminId && active.status === "open" ? (
              <div className="border-line flex items-center justify-between border-t bg-amber-50/70 px-4 py-2 font-mono text-[10px] text-amber-800">
                ...
                >
                  {assign.isPending ? "Claiming…" : "Claim now"}
                </button>
              </div>
            ) : null}
            ...
            >
              ...
              <button
                ...
                className="bg-acid grid size-11 place-items-center rounded-lg text-black transition-opacity hover:opacity-90 disabled:opacity-40"
