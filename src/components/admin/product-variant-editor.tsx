      ...
      <div className="border-line mt-4 flex flex-col justify-between gap-4 border-b pb-6 sm:flex-row sm:items-end">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="bg-signal rounded-full px-2.5 py-0.5 font-mono text-[8px] font-bold tracking-wider text-white uppercase">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={addVariant}
            className="action-button inline-flex min-h-11 items-center gap-2 rounded-lg px-4 font-mono text-[9px] font-semibold tracking-wider uppercase"
          >
              ...
              <div className="flex justify-end pt-2">
                ...
                >
                  {updateMetadata.isPending ? (
                    <>
                      <LoadingSpinner size="sm" /> Saving Specifications…
                    </>
                  ) : (
                    "Save Specifications"
                  )}
          ...
          <section className="space-y-4">
            <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
              ...
              <button
                type="button"
                onClick={addVariant}
                className="action-button inline-flex min-h-9 items-center gap-1.5 rounded-lg px-3.5 font-mono text-[8px] font-semibold tracking-wider uppercase"
              >
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                >
                  {saveVariants.isPending ? (
                    <>
                      <LoadingSpinner size="sm" /> Saving Matrix…
                    </>
                  ) : (
                    "Save Variant Matrix"
                  )}
