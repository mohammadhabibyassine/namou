    ...
    <section className="space-y-6">
      ...
      <div className="hairline-panel p-5">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-3">
            <label
              className={`action-button inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-lg px-5 font-mono text-[9px] font-bold tracking-wider uppercase ${
      ...
      <div className="flex items-center justify-between">
        ...
        >
          {save.isPending ? (
            <>
              <LoadingSpinner size="sm" /> Saving Media…
            </>
          ) : (
            "Save Media Details"
          )}
