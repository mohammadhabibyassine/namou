      ...
      <div className="border-line flex flex-col gap-3 border-b p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="bg-acid inline-flex min-h-8 items-center gap-1.5 rounded-lg px-3 font-mono text-[8px] uppercase transition-opacity hover:opacity-90"
          >
      ...
      <form className="mt-7 space-y-6" onSubmit={submit}>
        ...
        <div className="border-line flex flex-col items-center justify-between gap-4 border-t pt-5 sm:flex-row">
          ...
          <button
            ...
            className="bg-acid flex min-h-12 min-w-72 items-center justify-center gap-2 rounded-lg px-6 font-mono text-[10px] font-semibold tracking-wider uppercase shadow-sm transition-opacity hover:opacity-90 disabled:opacity-40"
          >
            {create.isPending ? (
              <>
